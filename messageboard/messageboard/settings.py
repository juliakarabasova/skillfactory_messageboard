...
SECRET_KEY = 'django-insecure-s_7p+jxlx4yss38#l7!9q9-u=&_q_&_(fok_w1y6_^!q^3h*k+'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'extraPlugins': ','.join(
            [
                'uploadimage',  # Конфигурация загрузки изображений
                # остальные плагины, которые вам могут понадобиться
            ]
        ),
    },
}
